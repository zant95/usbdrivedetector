...
public class USBStorageDevice {
	...
	public int hashCode() {
		int hash = 7;
		hash = 89 * hash + (rootDirectory != null ? rootDirectory.hashCode() : 0);
		hash = 89 * hash + (deviceName != null ? deviceName.hashCode() : 0);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		return rootDirectory == other.rootDirectory || rootDirectory != null && rootDirectory.equals(other.rootDirectory);
	}
